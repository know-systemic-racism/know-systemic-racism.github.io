...
The data lab is a library and digital humanities project that explores collections as data and data as collections. 
...
#### [data](https://github.com/know-systemic-racism/ca-leas-data) | [search](lea-search-bar.html)
...
```
## Fatal Encounters 
#### [search + visualizations](fe-search-viz.html)
